        ...
        <div>
            <div className='container mx-auto py-[60px] md:py-[80px] lg:py-[120px] xl:py-[150px] 2xl:py-[200px] sm:px-0 px-[24px] sm:mb-[50px] lg:mb-[70px'>
                <div className='flex justify-center items-center flex-col '>
                    <span className='componiesp !text-[#252A4E] hover:!text-[#252A4E]'>Our Blog</span>
                    <h2 className="mettingcompo m-0 mt-[15px] lg:mt-[24px] mb-[20px] lg:mb-[32px] text-center">Apex capital news & resources</h2>
                    <span className='componiesp !text-[#252A4E] hover:!text-[#252A4E]'>The latest industry news portfolio updsates, and <br/> investment insights from the apex capital team.</span>
                </div>
                <div className='flex sm:flex-row flex-col gap-[142px] sm:gap-[12px] md:gap-[16px] xl:gap-[21px] 2xl:gap-[25px] mt-100px justify-center'>
                    <div className='relative scale-[1] hover:scale-[1.05] duration-300'>
                        ...
                        <div className='imageunder'>
                            <span className='componiesp !text-[#252A4E] hover:!text-[#252A4E]'>news letter</span>
                            ...
                            <span className='componiesp !text-[#252A4E] hover:!text-[#252A4E]'>Apex capital portfolio summit welcome to bill bousfield, head of distribution ascension EIS & carry-back</span>
                        </div>
                    </div>
