    ...
    return (
        <div>
            <div className='container mx-auto px-[24px] sm:py-0 py-[60px] md:py-[80px] lg:py-[120px] xl:py-[150px] 2xl:py-[200px]'>
               ...
               <div className='flex flex-col-reverse items-end md:items-center justify-between  md:flex-row gap-[50px] md:gap-[80px] lg:gap-[120px] xl:gap-[160px] 2xl:gap-[200px] px-6 sm:px-0 h-full'>
